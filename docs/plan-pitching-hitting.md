...
- [ ] Refine PH-16-R4 shared versus separate Star Pitch/Swing pools, then consolidate remaining contracts; compare the tentative fatigue steering effect.

...
- [ ] Refine PH-08-R3 fatigue costs from pitching effort versus conceded outcomes, then consolidate remaining contracts; compare the tentative fatigue steering effect.

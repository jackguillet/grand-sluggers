...
**Proposal PH-13-R1 — pending Jack’s choice:** East / G cancels an uncommitted ordinary swing load and discards its charge; release of the swing button commits a swing, which then follows through. After cancel or conversion to bunt, the old held swing button must be released and pressed anew before another swing can load. Recommended: pressing an accepted directional bunt hold during a load discards the charge and squares up directly. Alternative: require explicit East/G cancel before bunting. These binding/transition details remain proposals, not newly accepted mechanics.
...
- [ ] Review PH-13-R1 cancel/swing-to-bunt flow, then consolidate input/trait contracts; compare the tentative fatigue steering effect.

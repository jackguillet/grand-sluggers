...
- [ ] Refine PH-15-R5 Contact versus Power attributes, then consolidate remaining trait/input contracts; compare the tentative fatigue steering effect.

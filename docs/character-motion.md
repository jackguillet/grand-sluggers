...
- **Who wears which.** Until CF-3's body-class row names `motionStyle`, `styles.byBody` maps a body type to its style. Role players wear their captain's body, so they get the captain's style.

...
| --- | --- | --- | --- |
| Shared rig | `data/art/rig.json` | `Assets/Art/Characters/SharedRig` | `MoveBones` pose graph |
| Clips | `data/art/clips.json` | `Assets/Art/Animation/Clips/{id}` | `MoveBones.Evaluate` |

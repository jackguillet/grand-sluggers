...
| 5 | Canopy Yard | Barrel cannons (ball redirect) + climb wall (wall trait) | Redirects grounders; any fielder can climb the wall and rob a homer (park rule, built: 28 ft, a trial number) | Fireflies (look) | Lanterns in the trees | Canopy, waterfalls |

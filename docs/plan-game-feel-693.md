...
**Next review — F693-02-pursuit-neutral-boundary:** [manual pursuit at .20 radial tilt, assistance at .15](research-game-feel-708.md#next-decision--neutral-and-manual-pursuit-boundary). Pending calibrated-input thresholds with retained ownership between them and manual speed mapped from .15. Calibration/arming and drift behavior follow separately; this is not a global input remap.

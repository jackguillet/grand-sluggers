...
**Next review — F693-02-ordinary-handling-resolution:** [consistent handling limits rather than an ordinary error chance roll](research-game-feel-708.md#next-decision--consistent-handling-limits-or-a-chance-roll). Actual condition inputs, trait curves and failure profiles remain pending; specials retain individual review.

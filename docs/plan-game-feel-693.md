...
**Next review — F693-02-mixed-status-action-readiness:** [recover actions individually as their restrictions end](research-game-feel-708.md#next-decision--action-readiness-with-multiple-statuses), preserving the accepted same-impact recovery sum and other active restrictions. Individual status definitions, repeated-effect clocks and arrival-speed anchors remain pending.

...
**Next review — F693-02-normal-jump-input-profile:** [consistent jump per eligible press, without hold-for-height or release-to-shorten](research-game-feel-708.md#next-decision--normal-jump-press-and-hold-behavior). Numerical arc, early input/takeoff timing and character/ability variation remain pending; both Mario manuals were rechecked for their press-oriented controls without inferring measured arcs.

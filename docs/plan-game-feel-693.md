...
**Next review — F693-02-pursuit-braking:** [linear stop from ordinary full speed in .10 seconds](research-game-feel-708.md#next-decision--ordinary-pursuit-braking). Pending authored trial; constant braking magnitude per character, shorter stopping time from partial speed, and planned assisted arrival. Neutral stick retains assisted pursuit; no new stationary-catch prerequisite.

...
**Next review — F693-02-pursuit-reversal:** [full opposite-direction reversal using the accepted brake and start](research-game-feel-708.md#next-decision--full-pursuit-reversal). Pending authored trial: .10-second full-speed brake, then .20-second acceleration in the opposite direction, without a pivot pause. Angled corrections follow separately.

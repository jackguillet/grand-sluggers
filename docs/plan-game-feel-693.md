...
**Next review — F693-03-relay-ownership:** [one deliberate command per onward relay leg, with early-input buffering](research-game-feel-708.md#next-decision--ownership-of-the-onward-relay-throw). Hold without a command; allow cancel/retarget before release motion starts. Pending control direction; buffer duration and cancel mapping remain separate details. Special-throw interactions follow.

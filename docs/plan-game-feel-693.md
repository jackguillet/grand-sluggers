...
**Accepted retention curve — F693-02-continuing-error-retention-curve, September 15, 2026:** [linear 80% to 50% progression](research-game-feel-708.md#accepted-decision--continuing-deflection-retention-curve). Midpoint 65%; geometry metric and branch boundaries remain open.

**Accepted obstruction basis — F693-02-error-contact-obstruction-basis, September 15, 2026:** [three-dimensional contact incidence](research-game-feel-708.md#accepted-decision--physical-contact-obstruction-basis). Geometry, normalization and classifier thresholds remain unselected.

**Accepted glove surface — F693-02-glove-contact-surface, September 15, 2026:** [smooth concave pocket and rounded rim](research-game-feel-708.md#accepted-decision--glove-contact-surface). Contact geometry stays separate from reach; dimensions/back/cuff/body response remain open.

**Next review — F693-02-glove-catch-sides:** [eligible pocket, rim or back contact can secure the ball](research-game-feel-708.md#next-decision--which-glove-sides-can-secure-the-ball). No pocket-facing gate; actual glove contact, action readiness and error rules still apply.

...
**Open decision — F693-02-catch-reach-envelope:** [reach and coverage accounting for C80](research-game-feel-708.md#reach-and-coverage-accounting-for-c80). The compact alley is 30% narrower against unchanged reach and pursuit, so today's 13-foot stand-up radius closes it about a second earlier than the control, and closes the third-to-short hole at 1.07 seconds. Keep the absolute feet, scale them with the basepath, or re-author a smaller envelope the visible glove can meet. Put to Jack on September 15, 2026; no value is selected, and the per-character source must move off displayed Fielding either way.

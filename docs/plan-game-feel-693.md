...
**Next review — F693-02-ordinary-handling-error-cap:** [10% ceiling per qualifying difficult ordinary acquisition attempt](research-game-feel-708.md#next-decision--maximum-ordinary-handling-error-chance). Specials remain separate; this is neither a blanket chance nor an observed per-game rate.

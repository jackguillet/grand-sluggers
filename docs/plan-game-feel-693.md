...
**Next review — F693-02-local-bobble-ground-horizontal:** [80% horizontal retention at each actual ground impact](research-game-feel-708.md#next-decision--local-bobble-horizontal-response-at-ground-impact). Applies once per real impact, including vertical settling; rolling friction remains pending.

...
**Next review — F693-02-error-contact-obstruction-basis:** [how squarely relative ball motion meets the actual contact surface](research-game-feel-708.md#next-decision--physical-contact-obstruction-basis). Three-dimensional incidence; geometry, normalization and classifier thresholds remain unselected.

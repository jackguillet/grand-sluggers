...
**Next review — F693-02-normal-jump-takeoff-ownership:** [start promptly from eligible input instead of scheduling to the ball](research-game-feel-708.md#next-decision--who-determines-normal-jump-takeoff-timing). Numerical startup and any early-input buffer remain separate; existing control/recovery restrictions stay authoritative.

...
**Next review — F693-02-ordinary-handling-chance-curve:** [linear difficulty and handling response: 10% / 6% / 2% at full difficulty](research-game-feel-708.md#next-decision--difficulty-and-handling-probability-curve). Physical difficulty and underlying trait mappings remain unselected.

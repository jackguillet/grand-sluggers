...
**Next review — F693-02-ground-pickup-recoil-basis:** [actual incoming pickup speed plus Field rating](research-game-feel-708.md#next-decision--retained-ball-ground-pickup-recoil-basis), deterministic, with zero recovery in the routine region. Threshold/duration/Field curve, physical reaction and special cases remain separate.

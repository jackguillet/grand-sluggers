...
**Next review — F693-02-awkward-hop-difficulty-source:** [awkward in-between hop at actual ground-ball acquisition](research-game-feel-708.md#next-decision--awkward-hop-as-the-first-difficulty-source). First proposed context, not a complete catalog or numerical mapping; clean rolls/short/long hops remain outside this source.

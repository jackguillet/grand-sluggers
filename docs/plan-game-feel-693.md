...
**Accepted movement trial — F693-02-field-dash-peak, September 14, 2026:** [1.20x peak ordinary fielding dash speed](research-game-feel-708.md#accepted-decision--fielding-dash-peak-speed). Accepted 20% peak boost; duration/availability and physical response follow separately. Spec's two-second fade is not present in the inspected held-boost path and must be reconciled in that next decision.

**Next review — F693-02-field-dash-duration:** [maximum two-second continuous dash window](research-game-feel-708.md#next-decision--fielding-dash-duration), including build-up, followed by return toward ordinary running. Recovery/re-arming and numerical physical response remain separate; no instant velocity clamp or refill is selected.

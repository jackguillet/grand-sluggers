...
**Next review — F693-02-catcher-read-clock:** [0.45-second base catcher pursuit read after batted contact](research-game-feel-708.md#next-decision--catcher-post-contact-read). Pending authored trial; no added rise/camera delay and no new wait on steal throws or home receptions. Validate bunt/short-pop races with the preserved catcher start.

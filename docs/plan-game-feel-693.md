...
**Dash scope reopened, September 14, 2026:** Jack approved a 20% universal sprint peak and then the two-second proposal, before redirecting the mechanic to automatic speed for ability holders carrying the ball. The [replacement carrier proposal](research-game-feel-708.md#current-dash-revision--passive-ball-carrier-ability) recommends a 20% passive carry-speed trial with no burst/cooldown. Its new numerical scope remains pending. Preserve earlier approvals as history; suspend the sprint recovery branch. No current character record assigns Ball Dash, so roster allocation is a separate decision.

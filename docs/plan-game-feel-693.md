...
**Next review — F693-02-bobble-stun-handling:** [modest handling-based reduction of stun duration](research-game-feel-708.md#next-decision--handling-and-bobble-stun-duration). Direction only; base duration, reduction and readable minimum remain unselected.

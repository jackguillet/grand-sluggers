...
**Next review — F693-02-jump-catch-throw-readiness:** [land before starting a normal throw after a jumping catch](research-game-feel-708.md#next-decision--throwing-after-a-jumping-catch), with no generic extra clean-landing pause. Actual jump/landing motion, airborne impact and exceptional variants remain separate.

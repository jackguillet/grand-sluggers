...
**Next review — F693-02-continuing-error-speed-retention:** [50–80% of actual pre-contact horizontal speed](research-game-feel-708.md#next-decision--continuing-deflection-speed-retention). Contact-dependent bounds only; mapping, branch thresholds and vertical response remain pending.

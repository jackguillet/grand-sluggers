...
**Next review — F693-02-local-bobble-rolling-deceleration:** [six-ft/s-per-second rolling slowdown](research-game-feel-708.md#next-decision--local-bobble-rolling-slowdown). A 5.4-ft/s roll stops in .90 seconds over 2.43 feet if untouched; ground-only arithmetic.

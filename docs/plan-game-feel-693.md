...
**Next review — F693-02-outfield-read-clock:** [0.40-second base outfield pursuit read from contact](research-game-feel-708.md#next-decision--outfield-post-contact-read), with no extra camera wait. Pending authored trial shorter than the reported GameCube read; retain contact-clock ownership and existing airborne cap. Infield/pitcher/catcher timing follows separately.

...
**Next review — F693-02-special-pushback-actions:** [ordinary recoil permissions for pure special pushback](research-game-feel-708.md#next-decision--actions-during-pure-special-pushback): delay steering/throw starts, preserve valid held-ball contact and input management. Other statuses, individual effects and arrival-speed anchors remain pending.

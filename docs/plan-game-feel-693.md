...
**Next review — F693-02-local-bobble-settling:** [settle when the next rebound would rise one inch or less](research-game-feel-708.md#next-decision--local-bobble-settling). Evaluate at actual ground collision and preserve horizontal motion and same-error recovery.

...
**Next human choice — post-contact read:** the [movement report](research-game-feel-701-movement.md#next-human-choice--f693-02-post-contact-read) records GameCube’s community-reported control lockouts and Harbor’s separate eligibility/view-change clocks. Recommend retaining a brief, visibly communicated read before ordinary pursuit, followed by the accepted responsive movement; alternative: remove the deliberate selected-fielder read. This remains pending and selects no delay, per-position schedule, difficulty change, or camera-dependent sim gate. Do not use extended freezing to manufacture extra-base opportunities.

...
**Next review — F693-02-recoil-field-shaping:** [shared incoming-speed onset; Field reduces duration after severity is capped](research-game-feel-708.md#next-decision--fieldings-role-in-ordinary-recoil), preventing the .20 cap from erasing stat differences at high severity. Numerical thresholds/curves/factors remain unselected.

...
**Next review — F693-03-snap-throw:** [0.22-second release after cleanly receiving a teammate throw, replacing the 1.22× flight-speed boost](research-game-feel-708.md#next-decision--snap-throw-as-a-quick-transfer). Pending trial ability definition; ordinary pickups remain at 0.30 seconds and chemistry affects flight only. Laser and exact input-buffer/cancel details follow individually.

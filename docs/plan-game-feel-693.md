...
**Next review — F693-03-throw-cancel:** [RB / period cancels a queued defensive throw; existing bag selectors retarget it](research-game-feel-708.md#next-decision--cancel-and-retarget-a-queued-throw). Pending contextual binding with explicit item-input precedence and selected-versus-queued feedback; no timer refresh on retarget.

...
**Next review — F693-02-special-impact-motion-composition:** [combine ordinary and special motion concurrently from the same impact](research-game-feel-708.md#next-decision--combining-ordinary-and-special-impact-motion), with individual source bounds and motion clocks, preserving the accepted additive action recovery. Individual special strength/resistance and arrival-speed anchors remain pending.

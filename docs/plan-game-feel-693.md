...
**Next research action — F693-02-arcade-fielding-validation:** consolidate the simplified contract and representative reference/play situations; bring meaningful gameplay tradeoffs to Jack one at a time. No glove microdecision awaits approval. Range dimensions, simple response mapping, traits, coverage and complete race validation remain open.

...
**Next review — F693-02-pursuit-calibration-samples:** [.50-second sample window, .10 maximum center offset, .02 maximum sample deviation](research-game-feel-708.md#next-decision--calibration-sample-acceptance). Pending numerical preset for requested non-live calibration, not routine arming. Failed sampling retains the prior profile; real controller validation remains open.

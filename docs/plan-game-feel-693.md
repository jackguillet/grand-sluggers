...
**Next numerical review — F693-03-travel-clock:** [0.90-second ordinary infield flight over 80 feet](research-game-feel-708.md#next-decision--ordinary-infield-ball-travel), proportional to distance for the neutral middle arm; 1.20 seconds including the accepted release. Pending. Long-throw reach and relay behavior follow separately; do not extrapolate this anchor as an accepted whole-field curve.

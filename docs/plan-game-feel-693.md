...
**Next review — F693-02-grounded-air-catch-recoil:** [reuse ordinary recoil response for qualifying hard airborne catches by grounded fielders](research-game-feel-708.md#next-decision--impact-recoil-on-grounded-airborne-catches). Routine catches retain zero added delay; airborne trigger speeds and whether they share ground anchors require evidence and separate review.

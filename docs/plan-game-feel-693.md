...
**Next review — F693-02-normal-jump-startup-trial:** [zero added gameplay delay before an eligible normal jump](research-game-feel-708.md#next-decision--normal-jump-startup-timing). Physical and visible takeoff must agree; device latency and buffering ineligible input remain separate.

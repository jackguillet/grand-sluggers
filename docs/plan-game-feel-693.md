...
**Next review — F693-02-error-direction-distribution:** [symmetric triangular directional variation](research-game-feel-708.md#next-decision--ordinary-error-direction-distribution). Small offsets more common; 75% within the central half of each accepted angular range.

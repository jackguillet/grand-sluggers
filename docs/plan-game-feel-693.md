...
**Next review — F693-02-normal-jump-glove-tracking:** [modest authored glove adjustment, with Field-dependent responsiveness within physical reach](research-game-feel-708.md#next-decision--glove-adjustment-during-a-normal-jump). Numerical limits and compatible authored motion representation remain required; no root assistance or invisible reach.

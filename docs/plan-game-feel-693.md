...
**Next review — F693-02-pursuit-arming:** [neutral once at role/device recovery boundaries, retained readiness through the half](research-game-feel-708.md#next-decision--pursuit-readiness-and-held-direction). Pending policy: valid calibrated neutral <=.15 without extra dwell, held direction works at contact, other verb guards and recovery pause behavior remain explicit.

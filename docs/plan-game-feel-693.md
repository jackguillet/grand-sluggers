...
**Next human choice — movement weight:** [movement report](research-game-feel-701-movement.md#next-human-choice--f693-02-movement-weight). Recommend a brief build-up to running speed with quick course corrections and little residual drift, versus heavier momentum that requires more commitment to a route. This is pending; it selects no timings and changes neither reaction eligibility nor neutral-stick assistance. Compare actual physical movement separately from rendered facing before numerical acceptance.

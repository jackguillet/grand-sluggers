...
**Accepted replacement — F693-02-ball-dash-carrier, September 14, 2026:** [automatic 20% Ball Dash](research-game-feel-708.md#current-dash-revision--passive-ball-carrier-ability), only for ability holders securely carrying the ball, without activation or burst/cooldown. This supersedes universal fielding sprint and its two-second proposal, preserving their history. Carry base/response and roster allocation remain separate.

**Next review — F693-02-ordinary-carry-speed:** [ordinary carrying top speed equals ordinary pursuit top speed](research-game-feel-708.md#next-decision--ordinary-carrying-speed), with the accepted Ball Dash factor applied only to eligible carriers. Run-5 would carry at 18 or 21.6 ft/s. Numerical response and complete races remain separate.

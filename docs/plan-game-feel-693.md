...
**Next review — F693-02-recoil-severity-curve:** [linear severity between shared onset/full-severity incoming speeds](research-game-feel-708.md#next-decision--ordinary-recoil-severity-curve). Numerical speed anchors stay null pending event-sided arrival evidence and coherent ball-motion calibration; choose shape only.

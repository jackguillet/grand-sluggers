...
**Next review — F693-02-pursuit-speed:** [18 ft/s ordinary Run-5 pursuit, scaling the existing relative stat curve](research-game-feel-708.md#next-decision--ordinary-pursuit-top-speed). Pending top-speed trial; read, acceleration/braking, dash/status and coverage follow separately. Compare both routine-defense cost and compact deep-chase gains; no candidate simulation is claimed.

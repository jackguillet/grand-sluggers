...
**Next review — F693-02-normal-jump-input-buffer:** [.10-second grounded early-input grace across temporary read/recovery restrictions](research-game-feel-708.md#next-decision--slightly-early-normal-jump-input). No airborne queue or ball scheduling; explicit expiry, cancellation and ownership boundaries.

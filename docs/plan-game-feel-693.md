...
**Next review — F693-02-pursuit-acceleration:** [linear 0.20-second ordinary pursuit build-up from rest](research-game-feel-708.md#next-decision--ordinary-pursuit-acceleration). Pending authored trial, same duration across characters at their respective top speeds; movement starts when eligible, without extra standstill. Braking and turning follow separately.

...
**Next review — F693-03-laser-throw:** [25% travel-speed bonus on actual throws home with a runner on third or between third and home](research-game-feel-708.md#next-decision--laser-as-a-home-plate-specialty), replacing the universal 45% bonus. Pending authored trial; ordinary release remains, chemistry stacks once and no bonus passes through the entire relay chain.

...
**Next review — F693-02-glove-contact-surface:** [smooth concave pocket and rounded rim](research-game-feel-708.md#next-decision--glove-contact-surface). Match the authored visible glove while keeping contact geometry separate from character reach; dimensions and back/cuff/body response remain open.

...
**Next review — F693-02-field-dash-peak:** [1.20x peak ordinary fielding dash speed](research-game-feel-708.md#next-decision--fielding-dash-peak-speed). Pending 20% peak boost; duration/availability and physical response follow separately. Spec's two-second fade is not present in the inspected held-boost path and must be reconciled in that next decision.

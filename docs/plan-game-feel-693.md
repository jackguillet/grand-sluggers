...
**Next review — F693-02-ground-pickup-recoil-cap:** [.20-second ordinary retained-ball recovery ceiling](research-game-feel-708.md#next-decision--retained-ball-ground-pickup-recovery-cap). Not a fixed pause: routine pickups remain zero. Trigger/curve/Field mapping and physical/action recovery remain separate; .25 buffer/.30 release remain intact.

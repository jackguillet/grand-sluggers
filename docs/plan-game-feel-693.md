...
**Next review — F693-02-continuing-error-retention-curve:** [linear 80% to 50% progression with increasing continuing-contact obstruction](research-game-feel-708.md#next-decision--continuing-deflection-retention-curve). Midpoint 65%; actual geometry metric and branch boundaries remain unselected.

...
**Next review — F693-02-bobble-direction-spread:** [up to 15 degrees either side horizontally](research-game-feel-708.md#next-decision--horizontal-bobble-direction-spread). Bound only; distribution, contact mapping, vertical treatment and scatter values remain pending.

...
**Next review — F693-02-grounded-bobble-braking:** [ordinary braking within the stun](research-game-feel-708.md#next-decision--grounded-bobble-braking). Full ordinary speed stops in .10 seconds, concurrently with the .40-second stun; grounded locomotion only.

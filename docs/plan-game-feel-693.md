...
**Next review — F693-02-special-impact-repeat-eligibility:** [one physical hit per fielder per special activation by default](research-game-feel-708.md#next-decision--repeat-hits-from-the-same-special), with explicitly reviewed multi-hit exceptions. New-attack chains, repeated impulse composition and individual attack contracts remain pending.

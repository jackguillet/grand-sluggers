...
**Next review — F693-02-error-outcome-selection:** [current ball motion and contact determine the consequence](research-game-feel-708.md#next-decision--selecting-the-ordinary-error-outcome). No separate severity roll recommended; numerical classifier and retained-motion model remain pending.

...
**Next review — F693-02-normal-jump-arc-trial:** [2-foot root rise over .60 seconds, with a midpoint apex](research-game-feel-708.md#next-decision--normal-jump-height-and-airtime-trial). Authored baseline trial; actual glove reach, character/ability variation, air-control strength and matched reference measurements remain pending.

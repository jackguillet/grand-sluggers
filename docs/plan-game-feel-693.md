...
**Next review — F693-03-negative-chemistry:** [predictable 0.90× bad-pair travel speed instead of the additional random slant](research-game-feel-708.md#next-decision--bad-chemistry-and-routine-reliability), ordinary release unchanged. Pending deliberate deviation from Mario-style occasional off-target chemistry throws. General accuracy/errors remain separately governed.

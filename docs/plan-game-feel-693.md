...
**Next review — F693-02-continuing-error-recovery:** [reliable recovery of the same continuing handling error](research-game-feel-708.md#next-decision--recovery-of-a-continuing-ordinary-error). An untouched miss grants no recovery protection; the later first handling attempt keeps its normal rules.

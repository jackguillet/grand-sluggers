...
**Next review — F693-02-ordinary-recoil-actions:** [block commanded steering/throw starts; preserve valid force/tag contacts and input management](research-game-feel-708.md#next-decision--actions-during-ordinary-recoil). Ordinary recoil only; physical motion, special permissions and evidence-based speed thresholds remain separate.

...
**Next review — F693-03-input-buffer:** [0.25-second maximum age for an early onward-throw command](research-game-feel-708.md#next-decision--how-long-an-early-throw-press-remains-valid). Execute immediately when secure possession/recovery permits; expire otherwise. Pending numerical trial. Cancel/retarget mapping and feedback follow separately.

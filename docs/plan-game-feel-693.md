...
**Next review — F693-02-recoil-field-factors:** [five-percentage-point factor reduction per Fielding point above 1](research-game-feel-708.md#next-decision--numerical-fielding-recovery-factors). Full-severity ordinary recoil .20/.16/.11 at Field1/5/10. Ratings, onset/full-severity speed and severity curve remain separate.

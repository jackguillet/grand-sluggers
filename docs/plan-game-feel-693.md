...
**Next review — F693-02-normal-jump-catch-input:** [one jump press, with no separate catch press on eligible actual contact](research-game-feel-708.md#next-decision--catching-during-a-normal-jump). Retain the existing input relationship through physical-jump work; no guaranteed possession or new geometric tolerance.

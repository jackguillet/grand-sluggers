...
**Next review — F693-02-ordinary-recoil-distance-cap:** [one-foot maximum added ordinary impact displacement](research-game-feel-708.md#next-decision--ordinary-pushback-distance-ceiling), separate from pre-existing movement and special impact bounds. Precise response and arrival-speed thresholds remain pending.

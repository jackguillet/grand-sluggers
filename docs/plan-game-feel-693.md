...
**Next review — F693-02-handling-error-opportunities:** [reliable routine acquisition, errors only in reviewed difficult/disrupted contexts](research-game-feel-708.md#next-decision--when-handling-errors-can-happen). No trigger catalog, probabilities or error-resolution model selected.

...
**Next review — F693-02-pursuit-calibration-policy:** [released-stick calibration outside live play, fixed through the match](research-game-feel-708.md#next-decision--stable-controller-calibration). Pending policy with explicit paused recalibration; sample acceptance and arming details remain open. Audit correction: StickPlay recenter magnitude is radial; the separate FieldAssist takeover test is L1.

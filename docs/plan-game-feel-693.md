...
**Next review — F693-02-bobble-recovery-permissions:** [ordinary movement available during brief fumbler-only glove recovery](research-game-feel-708.md#next-decision--bobble-recovery-permissions). Duration, handling influence and fresh-attempt rules remain unselected.

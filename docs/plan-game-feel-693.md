...
**Next review — F693-02-local-bobble-rebound-ceiling:** [six-inch maximum ground rebound](research-game-feel-708.md#next-decision--local-bobble-rebound-ceiling). A ceiling, not a fixed height or minimum; weaker impacts can settle. Authored proposal, with reference measurements still missing.

...
**Next review — F693-02-pitcher-read-clock:** [0.35-second base pitcher pursuit read from contact](research-game-feel-708.md#next-decision--pitcher-post-contact-read). Pending authored trial between the base infield and current pitcher timing; no extra camera/follow-through timer. Validate comebackers, bunts and delivery-to-field motion. Catcher follows separately.

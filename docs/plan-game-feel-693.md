...
**Next review — F693-02-ordinary-recoil-motion-profile:** [brief impact kick with steady slowing and smaller skids for stronger Fielding](research-game-feel-708.md#next-decision--ordinary-skid-response). Proposed `D=w²` feet and `K=10w` ft/s over the accepted `.20w` seconds, with existing locomotion braking retained. Actual arrival-speed thresholds and special physical composition remain pending.

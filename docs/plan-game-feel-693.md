...
**Next review — F693-02-carry-movement-response:** [shared carrying response with unchanged ordinary rates](research-game-feel-708.md#next-decision--carrying-movement-response). Ball Dash raises the target cap only: .24-second start/.12 stop/.36 full reversal at its full speed. Possession changes preserve actual velocity; recovery and movement eligibility remain explicit.

...
**Next review — F693-02-special-impact-field-resistance:** [up to 20% Fielding resistance to the special physical impact itself](research-game-feel-708.md#next-decision--fielding-resistance-to-special-impacts), separate from ordinary recoil and non-impact statuses. Individual special values, exceptions and arrival-speed anchors remain pending.

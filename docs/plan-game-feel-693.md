...
**Next review — F693-02-clean-ground-pickup-readiness:** [zero generic post-possession pause on routine clean ground pickups](research-game-feel-708.md#next-decision--clean-ground-pickup-readiness). Preserve visible acquisition, secure ownership and exceptional recovery; a valid command starts the existing .30-second ordinary release at readiness.

...
**Next review — F693-02-pursuit-angled-turn:** [continuous angled correction through shared brake/start rates](research-game-feel-708.md#next-decision--angled-pursuit-corrections). Pending authored trial: full-speed 45-degree turn about .115 seconds with 92% minimum speed; 90-degree about .212 seconds with 71% minimum speed. Continuous extension to the accepted reversal, no angle threshold or added stop.

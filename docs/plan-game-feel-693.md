...
**Next review — F693-02-local-bobble-horizontal-retention:** [20% of incoming horizontal speed, capped at six ft/s](research-game-feel-708.md#next-decision--local-bobble-horizontal-speed-retention). Actual pre-contact speed; zero input stays zero.

...
**Next review — F693-02-continuing-error-ground-response:** [shared ordinary batted-ball ground response](research-game-feel-708.md#next-decision--continuing-deflection-ground-response). Continue from actual deflected state; no local-bobble caps or added error-only braking. Numerical ordinary ground calibration remains pending.

...
**Sizing evidence and next human choice — ball readability:** the [proportions audit](research-game-feel-701-proportions.md) adds a bracketed Wii screen-space observation and all-seven-character nominal Harbor head-top/basepath calculations. GameCube low-resolution/contact and black-transition samples are excluded from numerical calibration; world-space reference body/basepath remains unresolved. Recommend modest bounded visual size assistance for distant moving balls with a glove-fitting held size, versus a fixed drawn world diameter relying on framing/contrast/trails. This is pending, selects no numerical scale, and leaves ball physics and judgments unchanged.

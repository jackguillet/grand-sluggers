...
**Next review — F693-03-long-throws:** [moderate arm-dependent loss of pace on very long direct throws](research-game-feel-708.md#next-decision--long-throws-and-relay-usefulness), so a well-positioned relay can sometimes be faster while direct throws remain available. Behavior pending; comfortable range and curve follow numerically. Relay continuation/hold/retarget controls also require explicit review before implementation.

...
**Next review — F693-02-repeated-impact-recovery:** [start each distinct impact recovery at its own arrival](research-game-feel-708.md#next-decision--recovery-from-repeated-physical-impacts), taking the latest applicable end without queuing full durations after unfinished waits. Same-impact ordinary/special addition stays intact; impulse composition, attack eligibility and anti-chain limits remain pending.

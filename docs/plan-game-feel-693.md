...
**Open decision — F693-02-dive-jump-scoop-reach:** [dive, jump and scoop reach after the six-foot decision](research-game-feel-708.md#dive-jump-and-scoop-reach-after-the-six-foot-decision). The runtime audit found the dive fires automatically for any fielder the seat is not steering and for every CPU fielder, so 6 feet plus an automatic 8 gives 14 feet of passive coverage — more than the 13 just removed, which would make the reach decision cosmetic for eight of nine defenders. The jump is already armed by a press and the loose-ball scoop is independent of catch radius; both are out of scope. Keep the automatic dive at 8 feet, shrink it, or make the dive an earned press. Put to Jack on September 15, 2026; no value is selected.

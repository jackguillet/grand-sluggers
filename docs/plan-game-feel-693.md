...
**Next review — F693-02-jump-air-control:** [limited horizontal correction with preserved takeoff momentum](research-game-feel-708.md#next-decision--control-during-a-normal-jump), same policy before/after a catch. Numerical control limits must be reviewed with jump airtime; exceptional motion remains separate.

...
**Next review — F693-02-continuing-error-direction:** [same ±30-degree contact-based horizontal variation](research-game-feel-708.md#next-decision--directional-variation-of-a-continuing-ordinary-error). No added angle for untouched misses; distribution and retained-motion model remain pending.

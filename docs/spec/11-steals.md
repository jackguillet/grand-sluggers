...
- A human throw command starts transfer at possession or when pressed afterward. CPU command reaction is separate: `0.42 − Hands × 0.014 ± 0.10` seconds, clamped to 0.10–0.58 before the difficulty reaction multiplier. Both then pay the shared physical preparation time.

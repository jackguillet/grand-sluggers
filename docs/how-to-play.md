...
SET forks **by role in 1P**, and **stays behind home in 1v1**. **One pad, pitching:** camera stays on the **mound 3/4** (`mound`) — behind the pitcher, rubber in the bottom, looking at the box — through SET and the throw. **One pad, batting:** camera stays on the **plate 3/4** (`plate`) — first-base over-the-shoulder behind home, batter left of the look, pitcher in the diamond — through SET and the throw. It does not cut to `pitch`. **Two pads:** camera stays on the **plate 3/4** (`plate`) — behind home — through SET and the throw, whether you pitch or hit. Pad 2 does not fork the HUD. Pink/gold charge ring **around the box** on the packed dirt (not a pancake under the feet). ~1s to the plate (Sluggers pace, not MLB 90). Home bats the bottom. Scorebug sits top-right; batter card bottom-left; pitcher card bottom-right. Highlight “your” card. Those anchors do not move.

...
- **East tap / G** — **dive**. An East / G press that cancelled a swing is not a dive until you let it up. The body lunges sideways relative to facing home plate, toward the ball’s side; it cannot dive toward or away from home. A dive catch or a dive scoop stamps **DIVE**. Nobody dives automatically: neither CPU opponents nor dead-stick assistance.

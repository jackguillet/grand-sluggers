...
North jumps or activates an eligible Buddy Jump/wall action. East dives; when a throw is queued, East cancels it and consumes the press. LB switches glove. RB feeds the cutoff or continues the relay. West attacks an eligible target. South answers the close-play icon. A tag still requires the ball and body to meet.

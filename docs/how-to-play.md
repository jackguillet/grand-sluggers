...
Press South / Space / left click to start the load; release the same button to throw or swing. A quick tap is the normal pitch or full slap swing. Hold until the rings line up, then release → **Nice!** / **Nice Hit!**. Holding beyond the MAX band loses power. The pitch has a **gold streak** so you can see it come in. Release the swing before the ball reaches home: the bat reaches contact 0.30 seconds after release. Timing is judged when the bat comes around. Only holding West / V / Ctrl bunts. The pitcher releases the ball at the 0.42-second mark of the delivery after button release. Pitcher, batter, and ball share contact slow-down and pause.
...
- **Stick L/R / WASD** — walk the rubber before the throw, or walk the box until the swing commits. **Down** resets. Pitching L/R is screen-relative from both the mound and plate cameras.
...
- **Sweet-spot oval** follows the batter, never the pitch. Walk so its center eats the ball. Center contact improves both contact and power; a charge narrows the timing window.

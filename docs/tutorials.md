...
- **Pitching:** T-P01 strikes; T-P02 aim/location and balls versus strikes; T-P03 changeup by the cycle; T-P04 charge/MAX; T-P05 break after release; T-P06 rubber positioning; T-P07 stamina/pitcher substitution; T-P08 pickoff; T-P09 star pitch; **T-P10 wrapping the cycle to a third pitch — planned (#825)**: no pitcher on the shipped root has an authored third family, so two presses land back on the fastball and there is no repeatable success to award. It unblocks when the `trials/pitch5` shapes are accepted (PH-20-R1, sitting 1).

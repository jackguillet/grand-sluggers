...
- **Tutorials:** `cli tutorials` is the live count (119 lessons implemented on 2026-09-25). They play from **Tutorials** on the title menu ([tutorials.md](tutorials.md)).
...
- **Fields:** Jack's greybox sitting at Crystal (checklist in [screenshot-gate.md](screenshot-gate.md)), then its art.

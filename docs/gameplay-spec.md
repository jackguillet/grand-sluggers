...
Under **F693-02-local-bobble-vertical-shape**, Jack approved on September 15, 2026 that an ordinary nearby bobble **spill down from actual glove contact with a low ground rebound**, without a default upward pop. Preserve real contact height and continuous motion; no fixed-height reset, ground snap or fake secured possession. Ball motion and the .40-second stun proceed independently, and eligible contact can recover before settling, including by a helper. Keep uniform ±30-degree local direction and reliable same-origin recovery. This qualitative shape does not govern continuing deflections, untouched balls or specials. Exact rebound height, contact response, horizontal speed and settling distance remain pending; no runtime or human gate changes here.

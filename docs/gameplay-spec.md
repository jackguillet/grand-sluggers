...
**Dash revision, September 14, 2026:** Jack subsequently approved the two-second burst proposal, then redirected dash toward automatic speed only for a character with the Dash ability while carrying the ball. This reopens the universal peak/duration scope above; do not implement it as the current direction. The [passive carrier replacement](research-game-feel-708.md#current-dash-revision--passive-ball-carrier-ability) recommends retaining 1.20x as a new carry-speed trial without activation/burst/recharge. Its numerical scope and roster allocation remain pending; other accepted movement/baserunning anchors remain intact. No runtime or human acceptance changes here.

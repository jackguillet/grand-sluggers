...
**#693 design amendment (F693-02-character-catch-range, September 15, 2026):** the target catch range is an explicit property independent of displayed Fielding; Field must not determine glove positioning/response. The historical Field-driven catch-radius model above needs reconciliation before implementation. A broader summary-rating architecture and migration of other Field consumers are pending; this does not silently revoke approved throwing/recoil rules.

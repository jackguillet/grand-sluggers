...
INFIELD = data_json.read(REPO / "data" / "rules" / "infield.json")
BOUNDARY = data_json.read(REPO / "data" / "rules" / "boundary.json")
PARK = data_json.read(REPO / "data" / "parks" / (PARK_ID + ".json"))

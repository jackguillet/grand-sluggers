...
public class FieldingSceneTests
{
    ...
    public void FieldBoundsUseEachParkFenceNotAHarborConstant()
    {
        ...
        var canopy = _content.Parks[ParkIds.Canopy];
        var ember = _content.Parks[ParkIds.Ember];
    ...
    {
        var hit = FlightFixtures.Landing(_content.Parks[ParkIds.Harbor], carry, launch, spray);

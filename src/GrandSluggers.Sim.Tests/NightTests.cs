...
public class NightTests
{
    ...
    public void SliceAndExhibitionDefaultToDay()
    {
        ...
        Assert.Equal(ParkId.Crystal, show.Park.Id);
    }
    ...
    public void NightIsStoredOnTheMatch()
    {
        ...
        Assert.Equal(ParkId.Harbor, harbor.Park.Id);
        var crystal = Match.Exhibition(_content, "vale", "brondo", seed: 7, parkId: ParkId.Crystal, night: true);
        Assert.True(crystal.Night);
        Assert.Equal(ParkId.Crystal, crystal.Park.Id);
    }
    ...
    {
        var park = _content.Parks[ParkId.Crystal];
        ...
        Assert.Equal(AtBatResolver.ContactWindowFrames(null, _content.Parks[ParkId.Harbor], true, rules: Rules.Default), nightWindow);
    ...
    {
        var catalog = _content.Parks[ParkId.Funfair];
        var byDay = Match.Exhibition(_content, "vale", "brondo", seed: 7, parkId: ParkId.Funfair).Park;
        var atNight = Match.Exhibition(_content, "vale", "brondo", seed: 7, parkId: ParkId.Funfair, night: true).Park;
        var mouthZ = 160.0;
        ...
        Assert.False(Mouth(Match.Exhibition(_content, "vale", "brondo", seed: 7, parkId: ParkId.Harbor, night: true).Park, 6));
    ...
    {
        var park = _content.Parks[ParkId.Ember];
        ...
        Assert.False(ParkHazards.InSlow(_content.Parks[ParkId.Harbor], 0, pastZ, night: true, rules: Rules.Default));
    ...
    {
        foreach (var id in new[] { ParkId.Harbor, ParkId.Crystal, ParkId.Funfair, ParkId.Ember })
        {

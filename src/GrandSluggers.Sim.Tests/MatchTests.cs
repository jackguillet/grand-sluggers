...
public class MatchTests
{
    ...
    {
        var match = Match.Slice(_content, seed: 1, parkId: ParkId.Crystal);
        Assert.Equal(ParkId.Crystal, match.Park.Id);
    ...
    {
        var match = Match.Slice(_content, innings: 3, seed: 11, parkId: ParkId.Crystal);
        match.AutoPlayGame();
        Assert.True(match.Over);
    ...
    {
        var park = _content.Parks[ParkId.Funfair];
        Assert.Equal(ParkId.Funfair, park.Id);
    ...
    {
        var park = _content.Parks[ParkId.Rooftop];
        Assert.Equal(ParkId.Rooftop, park.Id);
    ...
    {
        foreach (var id in new[] { ParkId.Harbor, ParkId.Crystal, ParkId.Funfair, ParkId.Rooftop })
        {
    ...
    public void CanopyYardHasBarrelsAndClimbWalls()
    {
        ...
        Assert.Equal(ParkId.Canopy, park.Id);
        Assert.Equal("dirt", park.Surface);
    ...
    public void EmberKeepLavaSlowsFielders()
    {
        ...
        Assert.Equal(ParkId.Ember, park.Id);

...
public sealed class StatusVolumeTests
{
    ...
    public void SF20_TheBurrowFielderIsNeverSlowed()
    {
        ...
        var probe = new Match(Catalog, PresetTeams.SparkAllStars(Catalog), PresetTeams.EmberCourt(Catalog), Catalog.MustPark(ParkIds.Harbor), seed: 1);
    ...
    public void SF20_AtTheRinkTheChaserWhoEntersTheDeepVolumeIsTheOnlyBodySlowed()
    {
        ...
        var match = Match.Slice(Catalog, seed: 1, parkId: ParkIds.Crystal);

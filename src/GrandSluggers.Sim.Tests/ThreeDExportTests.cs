...
public sealed class ThreeDExportTests
{
    ...
    public void Export()
    {
        ...
        Try("harbor-fixed-grounder", () => { var m = Defense702("cinder", ParkIds.Harbor); return Run(m, Hit(m, 84, 8, -12)); });
        Try("harbor-tactical-grounder", () => { var m = Defense702("cinder", ParkIds.Harbor); return Run(m, Landing(m, 118, 4, -18)); });
        Try("harbor-fly", () => { var m = Defense702("cinder", ParkIds.Harbor); return Run(m, Hit(m, 100, 30, -18)); });
        Try("relay", () =>
        {
    ...
    static Match DefenseDive()
    {
        ...
        return Match.Exhibition(Content, home, away, 3, 1, parkId: ParkIds.Harbor);
    }

...
public class InPlayTests
{
    ...
    public void HardHopperCanBobbleAndTheFumbleIsTimeNotACaption()
    {
        ...
        var hit = FlightFixtures.Hit(_content.Parks[ParkId.Harbor], 110, 6, -19, ContactQuality.Perfect);
    ...
    {
        // The class is typed on the hit (§6.2); a liner has its own 45° shot between hopper and fly (§15, #665).
        ...
        Assert.Equal(PlayCamera.InPlayLine, InPlay.TheaterShot(line));

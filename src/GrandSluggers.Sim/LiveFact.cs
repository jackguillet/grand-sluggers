...
/// and the seconds it stood still there before it ran on (a stall).
/// </summary>
public sealed record FirstHopKicked(string SwingId, double T, double X, double Z, double TurnDeg, string GloveId,

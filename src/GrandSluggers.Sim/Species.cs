...
/// names its species and wears its body. The species is catalog data for the bodies and the menus; the sidekick's own
/// row still names its specials and field ability.
/// </summary>

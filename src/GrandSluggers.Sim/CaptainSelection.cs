...
{
    readonly string[] _ids = PresetTeams.CaptainIds;
    ...
    public CaptainSelection(ExhibitionPick pick, bool versus)
    {
        Versus = versus; Pad1Home = pick.Pad1Home;
        _cursor[0] = Math.Max(0, Array.IndexOf(_ids, pick.Yours));
        _cursor[1] = Math.Max(0, Array.IndexOf(_ids, pick.Theirs));
    }

...
public static partial class HowToPlay
{
    ...
    [
        ...
        [
            ...
            "D-pad base + South: pickoff before charge; on the bag is safe. Select swaps any fielder before charging.",
        ],
        [
            ...
            "Take outside the white frame: ball. Swing and miss outside: strike.",
            "1/2/3/4 + Space: pickoff before charge; on the bag is safe. R swaps any fielder before charging.",
        ]),
        ...
        [
            ...
            "The tag decides: CAUGHT STEALING or STOLEN BASE. Before the catch, an inset shows the race. At the catch, the view flips close behind the catcher. Home and center stay upright; it tracks upfield with the throw.",

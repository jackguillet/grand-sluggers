...
public static class HowToPlay
{
    ...
    [
        ...
        [
            ...
            "One pad: you pitch over the pitcher's shoulder looking at the box. You hit from behind home. The throw does not cut.",
        ...
        [
            "The same diamond names runners and throw targets. Home is down.",
            "Advance sends everyone toward home. Return brings each runner back a bag. Both buttons halt.",
            "L3 steals the selected runner. No steal home. Dead stick: the catcher still guns.",
        ],
        [
            "The same diamond names runners and throw targets. Home is down.",
            "Advance sends everyone toward home. Return brings each runner back a bag. / halts both.",
            "Z steals the selected runner. No steal home. Don't move: the catcher still guns.",
        ]),

...
public static class HowToPlay
{
    ...
    [
        ...
        [
            ...
            "When the play is dead, a stamp names it on the field — BALL, STRIKE, FOUL, WALK, HIT BY PITCH, STRIKE OUT, OUT, DOUBLE PLAY, SINGLE, HOME RUN. Then SET for the next pitch. Counts are smaller and quicker. Runners still going keep play alive.",
        ],
        [
            "Scorebug    inning, runs, stars. B / S / O is balls, strikes, outs.",

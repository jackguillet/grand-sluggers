...
public static class HowToPlay
{
    ...
    [
        ...
        [
            ...
            "When the play is dead, a stamp names it — BALL, STRIKE, FOUL, WALK, BUNT, STOLEN BASE, CAUGHT STEALING, OUT, DOUBLE PLAY, SINGLE, HOME RUN. Counts are smaller and quicker. Runners still going keep play alive.",
        ],
        [
            "Scorebug    inning, runs, stars. B / S / O is balls, strikes, outs.",

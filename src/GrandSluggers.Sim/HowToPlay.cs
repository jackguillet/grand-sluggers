...
public static partial class HowToPlay
{
    ...
    [
        ...
        [
            ...
            "LB sends the selection; RB returns it immediately. D-pad Up halts. D-pad Down selects ALL. These commands also work before contact. LT owns Stars.",
        ...
        [
            ...
            "North jumps in window; the circle turns red. East dives. West attack. A homer sits on wall.",
        ...
        [
            ...
            "Choose stadium, time and hazards. Up/down focuses; left/right changes. Confirm Choose captains.",
        ],
        [
            "Title is the park (dirt + diamond). GRAND SLUGGERS is a sticker over the infield, left to right. No captain on the title.",

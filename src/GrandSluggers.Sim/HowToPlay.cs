...
public static class HowToPlay
{
    ...
    [
        ...
        [
            ...
            "The throw is yours: bag + South. Stick still runs with the ball. Outs land on the catch, the throw, a tag, or stepping on a force bag. They do not guess a force.",
        ...
        [
            "Don't move: the outfielder runs to the landing on a fly and still can catch. The ball hangs. Contact puffs dirt.",
            "The throw is yours: bag + Space. WASD still runs with the ball. Outs land on the catch, the throw, a tag, or stepping on a force bag. They do not guess a force.",

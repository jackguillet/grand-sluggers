...
public static class HowToPlay
{
    ...
    [
        ...
        [
            ...
            "SET is the plate 3/4 for pitch and swing. Same picture with one pad or two. Pad 2 does not move the camera.",
        ...
        [
            ...
            "Captains are the toys. Stick L/R home, U/D away. The card is the UI. The pick steps forward. Camera looks at the toy, not the brim.",
        ...
        [
            ...
            "SET is the same plate shot as 1P. Batter card bottom-left, pitcher card bottom-right. Highlight your card. HUD corners do not move.",

...
public static partial class HowToPlay
{
    ...
    [
        ...
        [
            "Start Exhibition: choose stadium, captains, lineup, positions/order, then settings.",
            ...
            "At stadium: stick L/R chooses the park, R3 toggles night, Select toggles hazards. South picks captains; South again opens lineup.",
        ],
        [
            "Start Exhibition: choose stadium, captains, lineup, positions/order, then settings.",
            ...
            "At stadium: A/D chooses the park, N toggles night, R toggles hazards. Space picks captains; Space again opens lineup.",
        ]),
        new("lineup", "Lineup", "lineup",
        [
            "Team Setup first, then Offense / Defense Setup.",
            "Pick a head. South adds them. Stars are set later. Focus shows a card and softly highlights buddies.",
        ...
        [
            "Team Setup first, then Offense / Defense Setup.",
            "Click a pool player to add them. Stars are set later. Hover shows a card and softly highlights buddies.",
        ...
        [
            ...
            "Q / Ready readies Player 1. Player 2 presses North on their pad. F withdraws readiness or returns to positions.",
            "Mercy never ends a 3-inning game. Stars OFF disables Star pitches, swings and Star gains for both teams.",
        ]),

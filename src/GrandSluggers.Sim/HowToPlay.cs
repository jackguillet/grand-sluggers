...
public static partial class HowToPlay
{
    ...
    [
        ...
        [
            ...
            "The tag decides: CAUGHT STEALING or STOLEN BASE. Before the catch, an inset shows the race. At the catch, the view flips behind the catcher. Home and center stay upright; it tracks upfield with the throw.",

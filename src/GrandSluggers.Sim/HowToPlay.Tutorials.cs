...
public static partial class HowToPlay
{
    ...
    public static string TutorialControls(string id, InputScheme scheme, string profile = "shipped")
    {
        ...
        return id switch
        {
            ...
            "T-P03" => pad ? "Stick aims. Press RB once to select the changeup, then tap South." : "Mouse aims. Press Tab once to select the changeup, then tap Space or left click.",
            "T-P10" => pad ? "Stick aims. Press RB twice to select your third pitch, then tap South." : "Mouse aims. Press Tab twice to select your third pitch, then tap Space or left click.",
            ...
            "T-B07" => pad ? "Line up with the stick. Hold LT (third) or RT (first) through the pitch to bunt." : "Line up with A/D or mouse. Hold J (third) or L (first) through the pitch to bunt.",
            "T-B08" => pad ? "Watch the pitch. Leave South, LT and RT alone as it passes." : "Watch the pitch. Leave Space, left click, J and L alone as it passes.",
            "T-B10" => pad ? "Hold South to load a swing. Press East before you let go. Then let the ball pass." : "Hold Space or left click to load a swing. Press G before you let go. Then let the ball pass.",
            "T-B11" => pad ? "Line up with the stick. Hold RT through the pitch. Let go of LT." : "Line up with A/D or mouse. Hold L through the pitch. Let go of J.",
    ...
    public static string TutorialFeedbackText(string code) => code switch
    {
        ...
        _ when code.StartsWith("star-pitch-") => "Your star pitch fired and spent its cost.",
        _ when code.StartsWith("star-swing-") => "Your star swing made fair contact and spent its cost.",
        ...
        _ when code.StartsWith("item-effect-") => "Your selected item landed and affected the defender.",

...
public static partial class HowToPlay
{
    ...
    public static string TutorialFeedbackText(string code) => code switch
    {
        ...
        "no-star-spent" or "star-pitch-missed" => "Select the star pitch and deliver it with enough meter.",
        "star-swing-missed" => "Select the star swing and time a fair hit with enough meter.",
        _ when code.StartsWith("star-pitch-") => "Your selected star pitch fired and spent its cost.",

...
public static partial class HowToPlay
{
    ...
    public static string TutorialSetup(string id) => id switch
    {
        ...
        "T-F04" => "The ball is still in the air. Move into catching position, then press catch in the window. Scooping it after a bounce does not count.",
    ...
    public static string TutorialControls(string id, InputScheme scheme)
    {
        ...
        return id switch
        {
            ...
            "T-F04" => pad ? "Left stick moves your glove. Tap South in the catch window." : "WASD moves your glove. Tap Space in the catch window.",

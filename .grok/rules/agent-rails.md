...
- End the session with the artifact of its kind: `cli match` / scenarios (`--trace` for tick JSON of ball / runner / glove / bag), a named shot, or still PNGs. Do not rebuild the `.app` as proof of look.

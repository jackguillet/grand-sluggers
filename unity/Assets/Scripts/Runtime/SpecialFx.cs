...
namespace GrandSluggers.UnityClient
{
    ...
    /// Throw-kind catalog slots stay as metadata; no ball-to-fielder beams are built.
    ...
    public sealed class SpecialFx : MonoBehaviour
    {
        ...
        {
            "heatball", "charmball", "prismball", "phonyball", "caskball", "skullball", "fogball", "mirageball",
            "heat-swing", "heart-swing", "shell-swing", "phony-swing", "cask-swing", "furnace", "staff-swing", "sidewinder",
            "buddy-flash"
        };

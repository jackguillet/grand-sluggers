...
namespace GrandSluggers.UnityClient
{
    ...
    public sealed class HarborKit : MonoBehaviour
    {
        ...
        public void EnsureAnchors()
        {
            ...
            ShotPlate = ShotAnchor("ShotPlate", new Vector3(0.4f, 3.6f, -2.8f), new Vector3(0.8f, 4.4f, 52f), 54f);
            ShotMound = ShotAnchor("ShotMound", new Vector3(-3.8f, 7.6f, 76.0f), new Vector3(0.4f, 2.2f, 2.5f), 46f);

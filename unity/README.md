...
Gamepad is the couch product. Keyboard and mouse are the same scheme (player 1). Couch map (title → lineup → pitch / swing / field, Training, F2 debug): **[docs/how-to-play.md](../docs/how-to-play.md)**. Keep that file in the same PR as control or camera-flow changes.

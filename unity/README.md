...
Gamepad is the product. Keyboard is a debug overlay. Couch map (title → lineup → pitch / swing / field, Training, F2): **[docs/how-to-play.md](../docs/how-to-play.md)**. Keep that file in the same PR as control or camera-flow changes.
